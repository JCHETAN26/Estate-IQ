...
> Build status: Phase 2 in progress. Phase 1 complete (DB + MCP + Zillow parsing). Phase 2 / Tasks 2.1 (mortgage + cash flow), 2.2 (rental estimation), 2.3 (Airbnb analyzer) complete. See [`build-plan.md`](./build-plan.md) for the sequenced roadmap.
